...

{
    ...
    //////   added overflow testing   ////////////////////////////////////////////////////////////////////////
    if (start > 0 && increment > 0 && result > std::numeric_limits<T>::max())
    {
        cout << "Test overflow: Addition failed ";
        return -1;
    }
...
T subtract_numbers(T const& start, T const& decrement, unsigned long int const& steps)
{
    ...
    //////   added underflow testing   ////////////////////////////////////////////////////////////////////////
    if (start > 0 && decrement > 0 && result < std::numeric_limits<T>::min())
    {
        cout << "Test underflow: Subtraction failed ";
        return -1;
    }
...
// 
   ...
   // code updated here for adding numbers with overflow 
    ...
    if (result != -1)
    {
        ...
        cout << " Overflow occured after Adding Numbers  \n";
    }
...
//  The solution must work for all of the data types used to call test_overflow() in main().
   ...
   // code updated here for subtracting numbers without overflow 
    ...
    // code updated here for subtracting numbers with overflow 
