// 
// Chloe Ninefeldt
// CS 405 4-2 Milestone: Unit Testing
// 05/28/20200
...
TEST_F(CollectionTest, VerifyTheCollectionIsErased) {
    add_entries(15);
...
TEST_F(CollectionTest, VerifyOutOfRangeExceptionRunsWhenCallingAtWithIndexOutOfBounds) {
...
TEST_F(CollectionTest, CollectionSwapsValues) {
    add_entries(4);
