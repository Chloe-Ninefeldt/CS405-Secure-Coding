// CS 405.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
bool do_even_more_custom_application_logic()
{
    ...
    throw std::runtime_error("Exception thrown - not happening.");
...
int main()
{
    ...
    try {
        ...
        std::cout << "Logical exception error!";
    }
}
